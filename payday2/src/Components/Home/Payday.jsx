            ...
            <div>
                <div className="flex  relative  justify-start object-cover   bg-cover bg-center bg-[url(./../public/static/img/team.jpg)] items-center py-16 px-5 md:px-12 ">
                    ...
                    <div className="bg-white flex flex-col  relative   shadow-xl rounded-lg  p-6 w-full md:w-[800px]  ">
                        <div className="  ">
                            <div>
                                <h2 className="md:text-[20px] text-[20px] lg:text-[30px]  font-Montserrat text-primary ">Get an online payday loan in Canada</h2>
                        ...
                        <div className="flex flex-col md:flex-row    justify-between  ">
                            ...
                            <div className="flex flex-col font-Montserrat gap-y-3 md:gap-y-4 py-4 md:py-0 ">
                                <button onClick={()=>{
                                    navi("/ApplyNow")
                                }} className=" border-[2px]  border-transparent   font-Montserrat bg-primary transition-all duration-300 hover:text-primary  py-2  md:py-3  md:h-[60px]  md:w-[210px] hover:bg-white hover:border-[2px]  hover:border-primary text-white rounded-lg text-[18px] md:text-[22px] ">Apply Now</button>


                                <button onClick={() => {
                                    navi("/Login")
                                }} className="flex font-Montserrat md:h-[60px]  md:py-0  py-[6px]   md:w-[210px] flex-row text-primary justify-center items-center border-[2px] border-primary  text-[18px]  md:text-[22px]  rounded-lg  gap-x-5">
                                    <img src="/static/img/userlogin.png" className="w-5 md:w-7 lg:w-10" />
                                    Login</button>
                            </div>
