...
const Faq = (props) => {
  ...
  const faqData = [
    {
      ...
      describe: `Canuckcash provides Canadians with online payday loans. Our payday loans are not intended to provide a long-term financial solution. Rather, they are intended to solve urgent but temporary cash-flow needs. `,
    },
    {
  ...
  return (
    <>
      ...
      <div className=" px-5  flex  pb-14  flex-col justify-center py-4 md:py-7      md:items-center items-center  ">
  ...
  return (
    <div className=" z-30   border-[#414141] ">
      <div
        ...
        onClick={toggle}
      >
        <div className="px-[15px] py-[10px] rounded-md w-full lg:w-[70rem] md:w-[42rem] ">
          <div className="flex  items-center gap-x-4 ">
            ...
            <p className="      text-justify  md:text-[14px] lg:text-[18px] text-[12px]   font-Montserrat text-seconday not-italic font-medium leading-[normal]">{title}</p>
